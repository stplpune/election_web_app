...
const routes: Routes = [
  ...
  { path: 'login', loadChildren: () => import('./login/login.module').then(m => m.LoginModule), data: { title: 'Login' }, canActivate: [NoAuthGuardService] },
  {
    ...
    component: PartialComponent, children: [
      ...
      { path: 'prominent-leader', loadChildren: () => import('./partial/settings/prominent-leader/prominent-leader.module').then(m => m.ProminentLeaderModule), data: { title: 'Prominent Leader', allowedRoles: ['1','2','7','8'] } },
      ...
      { path: 'booth-committee/:id', loadChildren: () => import('./partial/booth-management/booth-committee/booth-committee.module').then(m => m.BoothCommitteeModule), data: { title: 'Booth Committee', allowedRoles: ['1', '2', '7', '8'] } },
