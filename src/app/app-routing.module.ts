...
const routes: Routes = [
  ...
  { path: 'login', loadChildren: () => import('./login/login.module').then(m => m.LoginModule), data: { title: 'Login' }, canActivate: [NoAuthGuardService] },
  {
    ...
    component: PartialComponent, children: [
      ...
      { path: 'booth-committee', loadChildren: () => import('./partial/booth-management/booth-committee/booth-committee.module').then(m => m.BoothCommitteeModule), data: { title: 'Booth Committee', allowedRoles: ['1', '2','7'] } },
      ...
      { path: 'committee', loadChildren: () => import('./partial/organization-master/organization-master.module').then(m => m.OrganizationMasterModule), data: { title: 'Committee', allowedRoles: ['1', '2', '7'] }  },
      { path: 'committees-on-map', loadChildren: () => import('./partial/committees-on-map/committees-on-map.module').then(m => m.CommitteesOnMapModule), data: { title: 'Committees On Map', allowedRoles: ['1', '2', '7'] } },
      { path: 'committee-dashboard', loadChildren: () => import('./partial/committee-dashboard/committee-dashboard.module').then(m => m.CommitteeDashboardModule), data: { title: 'Committee Dashboard', allowedRoles: ['1', '2', '7'] } },
    ]
  },
