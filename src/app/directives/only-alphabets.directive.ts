...
export const CUSTOM_INPUT_ACCESSOR: StaticProvider = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => OnlyAlphabetsDirective),
  multi: true,
};
...
export class OnlyAlphabetsDirective implements ControlValueAccessor
{
